...
(function() {
    var provider = app.data.zeroOitocentos = new Everlive({
            offlineStorage: true,
            appId: '6imjrfulirub3yim',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'zeroOitocentos_access_token',
...
// START_CUSTOM_CODE_zeroOitocentos
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_zeroOitocentos